    ...
    if not api_key:
        ...
        try:
            ...
            ▶ [1번, 2번, 4번, 5번 항목] → 반드시 '개조식(명사형 종결)' 사용
               ...
               - 예시) "~심층적 이해에 도움이 됨.", "~보완이 필요하다고 판단됨.", "~경쟁력을 갖추었음."

            ▶ [3번 항목 중 '면접 예상 질문'] → 반드시 '완결된 질문 문장(의문문/평서문)' 사용
               - 면접관이 학생에게 직접 묻는 '실제 질문'이므로 개조식(~함/~임)을 절대 사용하지 말 것.
               - 반드시 '~까?', '~는가?', '~인가?', '~설명해 보세요.', '~말해 보시오.', '~생각하는지 설명하시오.' 등 '~다 / ~까 / ~요 / ~오' 형태의 완전한 문장으로 종결할 것.
               - 예시) "신약 개발 시 발생할 수 있는 윤리적 딜레마를 어떻게 해결할 수 있다고 생각하는가?"
               - 예시) "텔로미어 조절 기술이 가져올 사회적 영향에 대해 본인의 견해를 설명해 보세요."

            ▶ [3번 항목 중 '추천 심화 탐구 주제'] → 명사구 또는 개조식으로 작성(무방함)
               - 예시) "텔로미어 연구의 최신 동향과 노화 억제 기술의 윤리적 쟁점"
            ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

            💡 [형식 참고용 정답 템플릿 (톤앤매너 및 종결 어미 예시)]
            ### 1. 전공 적합성 및 주요 경쟁력
            ...
            **추천 심화 탐구 주제:**
            1. (명사구 형태의 주제)
            **면접 예상 질문 3가지:**
            1. (학생 활동을 언급한 뒤) ~에 대해 어떻게 생각하는지 설명해 보세요. [1학년 자율·자치활동]

            위의 모든 규칙과 템플릿을 완벽히 적용하여, 아래 5가지 양식에 맞추어 최종 결과물을 작성해 주세요.
            ### 1. 전공 적합성 및 주요 경쟁력 (테마별 엄선, 객관적/현실적 분석 서술, 100% 일치하는 분리 출처, 개조식 종결)
            ### 2. 범용 평가 기준에 비추어 볼 때 보완이 필요한 약점 (최소 2가지 이상 엄선된 약점 분석, 100% 일치하는 분리 출처, 개조식 종결) ※ 부재중인 학년의 기록 부족 지적 불가!
            ### 3. 추천 심화 탐구 주제 및 면접 예상 질문 3가지 (※ 면접 질문은 반드시 '~다/~까/~요/~오' 형태의 완결된 질문 문장으로 종결!)
            ### 4. 맞춤형 추천 도서 및 연계 활동 제안 (과목명: 순차번호. 도서명(저자) 형식 준수, ※ 도서 소개 문장은 반드시 개조식 종결!)
